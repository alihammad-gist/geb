...
import { MdMap, MdPlace } from 'react-icons/md';
...
export default ({ data: { strapiActivity: activity } }: { data: SingleResult }) => {
    return (
        <Layout>
                ...
                <>
                    ...
                    <PostMeta label="Location">
                        <iframe
                            ...
                            src={`https://maps.google.com/maps?q=${encodeURIComponent(activity.venue)}&t=&z=17&ie=UTF8&iwloc=&output=embed`}
                            allowFullScreen
                        />
                        <Media>
